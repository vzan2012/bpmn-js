 ...
 *
 */
export default class ModelCloneHelper {
  constructor(eventBus) {
    this._eventBus = eventBus;
  }

  clone(refElement, newElement, properties) {
    ...
    forEach(properties, (propName) => {
      ...
      if (isArray(refElementProp)) {
        ...
        forEach(refElementProp, (extElement) => {
          var newProp;
  ...
  _deepClone(propertyElement, context) {
    ...
    forEach(properties, (propName) => {
      ...
      if (propertyElement[propName] !== undefined &&
        ...
        if (isArray(propertyElement[propName])) {
          ...
          forEach(propertyElement[propName], (property) => {
