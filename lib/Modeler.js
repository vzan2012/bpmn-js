...
Modeler.prototype._interactionModules = [
  ...
  require('diagram-js/lib/navigation/touch').default,
...
Modeler.prototype._modelingModules = [
  ...
  require('./features/auto-resize').default,
  require('./features/editor-actions').default,
  require('./features/context-pad').default,
  require('./features/keyboard').default,
  require('./features/label-editing').default,
  require('./features/modeling').default,
  require('./features/palette').default,
  require('./features/replace-preview').default,
  require('./features/snapping').default
];
