...
export default class BpmnReplace {
  constructor(bpmnFactory, replace, selection, modeling, eventBus) {
    ...
    function replaceElement(element, target, hints) {
      ...
      var properties = getSharedProps(oldBusinessObject, newBusinessObject);
...
function has(el, prop) {
  return prop in Object(el);
}

function getSharedProps(oldBo, newBo) {

  var oldProps = getProperties(oldBo.$descriptor),
      newProps = getProperties(newBo.$descriptor, true);

  return reduce(oldProps, function(result, p) {
